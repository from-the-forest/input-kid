...
func _enter_tree():
	...
	add_custom_type("SplodeCaret", "Node", preload("res://addons/input_kid/text/candy/caret_splode.gd"), preload("res://addons/input_kid/text/candy/caret_splode.svg"))
...
func _exit_tree():
	...
	remove_custom_type("CaretSplode")
